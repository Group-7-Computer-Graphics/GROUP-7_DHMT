...
export function HUDControls({
  ...
  // Nhận hàm âm thanh lướt chuột
  playHover,

  // Nhận hàm âm thanh bấm
  playClick
}) {
  return (
    <div
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        >
          ORBIT SPEED:{" "}
          <span style={{ color: "white" }}>{solarSpeed.toFixed(1)}x</span>
        </label>
        <input
          type="range"
          min="0"
          ...
          // Âm thanh bấm
          onMouseDown={() => playClick && playClick()}
          style={{
            accentColor: "#00f3ff",
            cursor: "pointer",
            height: "4px",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        >
          GLOW INTENSITY:{" "}
          <span style={{ color: "white" }}>{bloomIntensity.toFixed(1)}</span>
        </label>
        <input
          type="range"
          min="0"
      ...
      >
        ...
        <button
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.backgroundColor = isCinematic
              ? "rgba(0, 243, 255, 0.4)"
              : "rgba(0, 243, 255, 0.2)"
          }}
          onMouseLeave={e => {
          ...
          style={{
            ...
            border: `1px solid ${
              isCinematic ? "#00f3ff" : "rgba(0, 243, 255, 0.4)"
            }`,
            borderRadius: "2px",
            cursor: "pointer",
            fontSize: "11px",
